...
namespace CQA.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    string confirmationToken =
                        WebSecurity.CreateUserAndAccount(model.UserName, model.Password, new { RealName = model.RealName, UrlName = urlName });
        ...
        public ActionResult ExternalLoginCallback(string returnUrl)
        {
            ...
            //Stores facebook token in session , Does not need right now
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (CQADBContext db = new CQADBContext())
                {
                    ...
                    if (user == null)
                    {
                        ...
                        string urlName = Helpers.StringHelper.CreateSeoFriendlyString(model.UserName) + "-" + Guid.NewGuid().ToString();
                        db.UserProfiles.Add(new UserProfile { UserName = model.Email, RealName = model.UserName, UrlName = urlName });
                        db.SaveChanges();
                        ...
                        //}
                        //else
                        //    ModelState.AddModelError("Email", "Nepodarilo sa ziskať Váš email.");
                    }
                    else
                    {
